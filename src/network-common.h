...
enum MessageType {
  ...
  MESSAGE_TYPE_P1_DEPART = 33,
  MESSAGE_TYPE_P2_DEPART = 34,
  MESSAGE_TYPE_P3_DEPART = 35,
  MESSAGE_TYPE_P4_DEPART = 36,
  MESSAGE_TYPE_P5_DEPART = 37,
  MESSAGE_TYPE_P6_DEPART = 38,
  MESSAGE_TYPE_P7_DEPART = 39,
  MESSAGE_TYPE_P8_DEPART = 40,
  MESSAGE_TYPE_VIEWER_DEPART = 41,
};
