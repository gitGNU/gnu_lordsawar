...
#define LORDSAWAR_TILESET_VERSION "0.1.9"
#define LORDSAWAR_ARMYSET_VERSION "0.1.9"
#define LORDSAWAR_CITYSET_VERSION "0.1.9"
#define LORDSAWAR_SHIELDSET_VERSION "0.1.9"
