...
const Gdk::Color SELECTED_CITY_BOX_COLOUR(WHITE_COLOUR);
const Gdk::Color BEVELED_CIRCLE_DARK(DARK_GREY_COLOUR);
const Gdk::Color BEVELED_CIRCLE_LIGHT(LIGHT_GREY_COLOUR);
